...
class Hero : public Living {
    ...
    public:
        ...
        : Living(name, 1), magicPower(INIT_MAGIC_POWER), strength(strength), dexterity(dexterity), agility(agility), money(INIT_MONEY), experience(0), weapon_left(NULL), weapon_right(NULL) {}
